(defproject chromatica1 "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "chromatica1.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main chromatica1.application
  ...
  :cljsbuild {:builds
              ...
              {:id "app"
                ...
                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/chromatica1.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main chromatica1.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main chromatica1.system
                           :output-to "resources/public/js/compiled/chromatica1.js"
                           :output-dir "target"
                           :source-map-timestamp true
  ...
  :profiles {:dev
             ...
             {:source-paths ^:replace ["src/clj" "src/cljc"]
              :prep-tasks ["compile"
                           ["cljsbuild" "once" "min"]
                           ["run" "-m" "garden-watcher.main" "chromatica1.styles"]]
              :hooks []
              :omit-source true
              :aot :all}})
