(ns user
  (:require [chromatica1.application]
            ...
            [chromatica1.config :refer [config]]))

(defn dev-system []
  (assoc (chromatica1.application/app-system (config))
    :figwheel-system (fw-sys/figwheel-system (fw-config/fetch-config))
    :css-watcher (fw-sys/css-watcher {:watch-paths ["resources/public/css"]})
    :garden-watcher (new-garden-watcher ['chromatica1.styles])))
